...
#insert header
echo 'File name,bp on target,Average coverage,No coverage,1x Coverage,10x Coverage,15x Coverage,50x Coverage,120x Coverage,200x Coverage,500x Coverage,1000x Coverage,1500x Coverage,2000x Coverage,2500x Coverage' > ${dir}/coverage_summary.csv
