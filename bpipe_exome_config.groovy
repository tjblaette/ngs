...
TRUSEQ="${NGS}/refgenome/hg19/TruSeq-Exome-Targeted-Regions-BED-file_sorted.bed" 
NEXTERA="${NGS}/refgenome/hg19/nexterarapidcapture_exome_targetedregions_v1.2_sorted.bed"
NEXTERA_EXPANDED="${NGS}/refgenome/hg19/nexterarapidcapture_expandedexome_targetedregions_sorted.bed"
EXON_TARGET=TRUSEQ
