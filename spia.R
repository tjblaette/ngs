...
res=spia(de=de,all=all,organism=ORG,data.dir=paste("/NGS/KEGG/",ORG,"/",sep=""),nB=2000,plots=TRUE,beta=NULL,combine="fisher",verbose=TRUE)
write.table(res, file=paste(OUT,"_spia.txt", sep=""), sep="\t")
