...
do
    ...
    java -cp /NGS/gsea/gsea2-2.2.1.jar -Xmx512m xtools.gsea.GseaPreranked -gmx $set -collapse false -mode Max_probe -norm meandiv -nperm 1000 -rnk ${IN%.txt}_forGSEA_stat.rnk -scoring_scheme weighted -rpt_label "$(basename ${IN})_$(basename ${set})_stat" -include_only_symbols true -make_sets true -plot_top_x 20 -rnd_seed timestamp -set_max 500 -set_min 15 -zip_report false -gui false
    java -cp /NGS/gsea/gsea2-2.2.1.jar -Xmx512m xtools.gsea.GseaPreranked -gmx $set -collapse false -mode Max_probe -norm meandiv -nperm 1000 -rnk ${IN%.txt}_forGSEA_lfc.rnk -scoring_scheme weighted -rpt_label "$(basename ${IN})_$(basename ${set})_lfc" -include_only_symbols true -make_sets true -plot_top_x 20 -rnd_seed timestamp -set_max 500 -set_min 15 -zip_report false -gui false
